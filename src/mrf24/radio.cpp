...
struct DATA::packet_tx bufferTransReceiver{};
...
bufferTransReceiver.checksum = calculate_crc8 ( reinterpret_cast<const uint8_t *>(bufferTransReceiver.data ) , reinterpret_cast<const uint8_t *>(bufferTransReceiver.size)); 
